...
<head>
    ...
    <title>Yachting Croatia Contact information - Mega Yacht Services Croatia</title>

  <meta charset="utf-8">
	<meta name="keywords" content="yacht agent, yacht provisioning, charter, fiscal representation, yacht services, yacht support, yacht supply, luxury transport, spare parts, technical assistance, luxury services">
...
<body>
    	...
    	<div id="NavBox">
        	...
        	<div id="NavMenu">
              ...
              <li><a href="/charter">Charter</a></li>
        			...
        			<li class="AktivnoNav"><a href="/contact">Contact</a></li>
      		  </ul>
    	    </div>
    	</div>
    </nav>
    ...
    <section id="KontaktTekst">
    	<h1 style="font-size:23px;">Contact</h1>
    <h2 style="font-size:20px;">MYS Croatia<br>
    Dubrovnik | Split | Rovinj</h2><br>
    <h1 style="font-size:20px; text-transform:none; line-height:1;">+ 385 99 502 3127<br>
    + 385 98 912 5198<br>
    info@myscroatia.com</h1>
    </section>
