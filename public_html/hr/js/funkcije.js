...
function displayCO2Info() {
		...
		$('#Co2Text').show();
		$('#Co2Text').removeAttr( 'style' );
		$('#Co2Text').animate({"right": "+=400px"}, 1000);
    	return false;
}
// boxevi na početnoj
$(document).ready(function() {
...
function FunkcijaLokalno(){
	...
	function onAfter1() {
			$('#Rizot').tinyscrollbar_update();
			$('#Buzara').tinyscrollbar_update();
			$('#Zec').tinyscrollbar_update();
			$('#Brudet').tinyscrollbar_update();
			$('#Krempite').tinyscrollbar_update();
			$('#Crescents').tinyscrollbar_update();
	}
	function onAfter2() {
			$('#Vino1').tinyscrollbar_update();
			$('#Vino2').tinyscrollbar_update();
			$('#Vino3').tinyscrollbar_update();
	}
	function onAfter3() {
			$('#Truffles').tinyscrollbar_update();
			$('#Cheese').tinyscrollbar_update();
			$('#Oysters').tinyscrollbar_update();
